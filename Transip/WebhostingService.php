...
class WebhostingService
{
	 ...
	 *
	 * @return Transip\WebhostingPackage[] List of available webhosting packages
	 */
	 ...
	 * a modifying function in Transip\WebhostingService is called (e.g. createCronjob()).
	 *
	 ...
	 * @return Transip\WebHost WebHost object with all info about the requested webhosting package
	 */
	 ...
	 * @param Transip\WebhostingPackage $webhostingPackage The webhosting Package to order, one of the packages returned by Transip\WebhostingService::getAvailablePackages()
	 ...
	 * @return Transip\WebhostingPackage[] Available packages to which the domain name can be upgraded to.
	 */
	 ...
	 * @param Transip\Cronjob $cronjob the cronjob to create. All fields must be valid.
	 */
	 ...
	 * @param Transip\Cronjob $cronjob Cronjob the cronjob to delete. Be aware that all matching cronjobs will be removed.
	 */
	 ...
	 * @param Transip\MailBox $mailBox MailBox object to create
	 */
	 ...
	 * @param Transip\MailBox $mailBox the MailBox to modify
	 */
	 ...
	 * @param Transip\MailBox $mailBox the MailBox to set the password for
	 ...
	 * @param Transip\MailBox $mailBox the mailbox object to remove
	 */
	 ...
	 * @param Transip\MailForward $mailForward The MailForward object to create
	 */
	 ...
	 * @param Transip\MailForward $mailForward the MailForward to modify
	 */
	 ...
	 * @param Transip\MailForward $mailForward the MailForward to delete
	 */
	 ...
	 * @param Transip\Db $db Db object to create
	 */
	 ...
	 * @param Transip\Db $db The db object to modify
	 */
	 ...
	 * @param Transip\Db $db Modified database object to save
	 ...
	 * @param Transip\Db $db Db object to remove
	 */
	 ...
	 * @param Transip\SubDomain $subDomain SubDomain object to create
	 */
	 ...
	 * @param Transip\SubDomain $subDomain SubDomain object to delete
	 */
