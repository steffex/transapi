...
class ColocationService
{
	...
	public static function _getSoapClient($parameters = array())
	{
		...
		if(self::$_soapClient === null)
		{
			...
			$classMap = array(
				'DataCenterVisitor' => 'DataCenterVisitor',
			);
	 ...
	 * @return DataCenterVisitor[] An array of Visitor objects holding information (such as reservation and access number) about
	 */
