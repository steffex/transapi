...
class DomainService
{
	 ...
	 * @throws ApiException
	 * @return Transip\DomainCheckResult[] A list of DomainCheckResult objects, holding the domainName and the status per result.
	 */
	 ...
	 * @return Transip\Domain A Domain object holding the data for the requested domainName.
	 */
	 ...
	 * @return Transip\Domain[] Domain objects.
	 */
	 ...
	 *
	 * @param Transip\Domain $domain The Domain object holding information about the domain that needs to be registered.
	 ...
	 *
	 * @param Transip\Domain $domain the Domain object holding information about the domain that needs to be transfered
	 ...
	 * @param Transip\Nameserver[] $nameservers the list of new nameservers for this domain
	 ...
	 * @param Transip\DnsEntry[] $dnsEntries the list of new DnsEntries for this domain
	 ...
	 * @param Transip\WhoisContact $registrantWhoisContact the new contact data for this
	 ...
	 * @param Transip\WhoisContact[] $contacts the list of new contacts for this domain
	 ...
	 * @return Transip\DomainAction if this domain is currently running an action, a corresponding DomainAction with info about the action will be returned.
	 ...
	 *
	 * @param Transip\Domain $domain The domain with data to retry
	 * @example examples/DomainService-DomainService-domainActions.php
	 * @throws ApiException
	 */
	 ...
	 *
	 * @param Transip\Domain $domain The domain to try the transfer with a different authcode for
	 ...
	 *
	 * @param Transip\Domain $domain the domain to cancel the action for
	 * @example examples/DomainService-DomainService-domainActions.php
	 * @throws ApiException
	 */
