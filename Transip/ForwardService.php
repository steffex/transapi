...
class ForwardService
{
	 ...
	 * @return Transip\Forward Forward object with all info if found, an exception otherwise
	 */
	 ...
	 *
	 * @param Transip\Forward $forward info about the forward to order. Mandatory fields are $domainName. Other fields are optional.
	 */
	 ...
	 *
	 * @param Transip\Forward $forward The forward to modify
	 */
